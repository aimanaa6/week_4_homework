...
# random.sample is a function for sequences -  returns a list of unique elements chosen from population sequence
...
# print a string and the output of the variable
